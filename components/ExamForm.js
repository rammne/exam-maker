  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 p-4 bg-white rounded-lg shadow-md">
      ...
      <div className="mb-4">
        ...
        <input name="course" placeholder="Course" className="input w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" onChange={handleChange} required />
      </div>
      <div className="mb-4">
